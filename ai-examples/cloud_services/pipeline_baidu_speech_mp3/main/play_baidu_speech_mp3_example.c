...
* 
* ch:
 本例的目的是演示如何使用播放由百度语音合成服务生成的文本中的音频。即为 在线合成语音！
 该示例提供中文文本，但也支持其他一些语言。
*
* en:
   The goal of this example is to show how to use Audio Pipeline to play audio generated from text
 by Baidu Speech synthesis service.
   The example provides text in Chinese, but some other languages are supported as well.
*
*/
static const char *TAG = "BAIDU_SPEECH_EXAMPLE";

#define BAIDU_TTS_ENDPOINT "http://tsn.baidu.com/text2audio"
#define TTS_TEXT "我们是深圳安信可科技有限公司，想了解更多方案信息请联系我们！"

// baidu appid and appscrect
#define CONFIG_BAIDU_API_KEY "YUFsEFiTUA8iNs2fksTHGIt7"
#define CONFIG_BAIDU_SECRET_KEY "ciiVibeOoUDQSTWAUobps1yGyYbttO4L"

#define CONFIG_WIFI_SSID "XuHongYss"
#define CONFIG_WIFI_PASSWORD "xuhongyss123456"
...
int _http_stream_event_handle(http_stream_event_msg_t *msg)
{
    ...
    if (baidu_access_token == NULL) {
        ...
        baidu_access_token = baidu_get_access_token(CONFIG_BAIDU_API_KEY, CONFIG_BAIDU_SECRET_KEY);
    }
